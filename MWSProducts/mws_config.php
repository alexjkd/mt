<?php
    ...
    * http://aws.amazon.com
    ***********************************************************************/
    define('AWS_ACCESS_KEY_ID', 'AKIAIQ3AR7PLQUFLUD5A');
    define('AWS_SECRET_ACCESS_KEY', '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');
    ...
    * marketplace ID.
    ***********************************************************************/
    define ('MERCHANT_ID', 'A2AB4EJKHRN74A');
    ...
    ***********************************************************************/
     function __autoload($className){
        $filePath = 'src/'.str_replace('_', DIRECTORY_SEPARATOR, $className) . '.php';
