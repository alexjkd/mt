...
/*  foreach($data as $csv_array_data){
    ...
    if (count($csv_array_data)>3 and preg_match_all('/B0\w{8}/',$csv_array_data[4],$m)) { //array of competitor asins  -John Chen 2019-09-10
  ...
  } //array of competitor asins  -John Chen 2019-09-10 */
  echo "<pre>"; print_r($asin_array); echo "</pre><hr>"; exit;
