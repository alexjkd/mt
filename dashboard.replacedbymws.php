...
function mydrawchart($aMapData,$title_c='',$title_x='',$yLegents='',$width=1600,$height=120){
	...
	// $plot->SetDefaultTTFont('/var/www/html/codiad/workspace/mws/mt/lib/Yagora.ttf');
	$plot->SetPrintImage(False);  // Do not output the image
	// $plot->SetFont('y_label', 2, 12);
	// $plot->SetFont('x_label', 2, 12);
	$plot->SetFontTTF('x_label', '/var/www/html/codiad/workspace/mws/mt/lib/Yagora.ttf', 9);
	$plot->SetFontTTF('y_label', '/var/www/html/codiad/workspace/mws/mt/lib/Yagora.ttf', 8);
